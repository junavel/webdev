...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="create_announcement.php" class="active">
              <i class="bi bi-circle"></i><span>Create Announcement</span>
            </a>
          </li>
          <li>
            <a href="announcement_list.php" class="active">
            ...
            <div class="announcement-list">
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<h4>$title</h4>";
                        echo "<p>$content</p>";
                        echo "<p class='text-muted'>$date $time</p>";
                        echo '</div>';
                    }
                } else {
  ...
  <script>
    $(document).ready(function () {
        // This array will hold the created announcements
        let announcements = [];
        ...
        $("#createAnnouncementForm").submit(function (e) {
            ...
            // Display the newly created announcement
        ...
        // Function to display the created announcement
        function displayAnnouncement(announcement) {
            ...
            // Append the announcement to the main content area
