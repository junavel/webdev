    ...
    <main>
        <div class="container">
            ...
            <div class="announcement-list">
                ...
                // Query to fetch historical announcements from the database
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        // Display each historical announcement
                        echo '<div class="announcement">';
                        echo "<h2>$title</h2>";
                        echo "<p>$content</p>";
                        echo "<p class='date-time'>$date $time</p>";
                        echo '</div>';
                    }
                } else {
                    echo '<p>No historical announcements available.</p>';
                }
