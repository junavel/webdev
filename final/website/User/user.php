    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-bar-chart"></i><span>Pie Charts</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
            <a href="genderPieChart.php">
  ...
  <main id="main" class="main">
    ...
    <section class="section">
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['edit_id'])) {
            ...
            $updateSql = "UPDATE access SET status = ? WHERE id = ?";
            ...
            if ($stmt->execute()) {
                ...
                echo '<div class="alert alert-danger">Error saving changes: ' . $stmt->error . '</div>';
            }
        }
        ...
        if (isset($_GET['edit_id'])) {
            ...
            if ($editResult->num_rows == 1) {
                ...
                echo '<form method="POST" action="user.php">'; // Create an update_user.php for processing the form data
